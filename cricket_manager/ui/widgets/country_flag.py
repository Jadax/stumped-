...
def draw_country_flag(surface:pygame.Surface, rect:pygame.Rect, country:str)->None:
    ...
    if country=="India":
        pygame.draw.rect(surface,"#FF9933",(r.x,r.y,r.w,r.h//3)); pygame.draw.rect(surface,"#138808",(r.x,r.bottom-r.h//3,r.w,r.h//3)); pygame.draw.aacircle(surface,"#000080",r.center,max(2,r.h//7),1)
    elif country=="Pakistan":
        pygame.draw.rect(surface,"#01411C",r); pygame.draw.rect(surface,"white",(r.x,r.y,r.w//4,r.h)); pygame.draw.aacircle(surface,"white",r.center,r.h//4); pygame.draw.aacircle(surface,"#01411C",(r.centerx+r.h//10,r.centery-r.h//12),r.h//4)
        ...
        pygame.draw.rect(surface,"#006A4E",r); pygame.draw.aacircle(surface,"#F42A41",(r.centerx-r.w//12,r.centery),r.h//3)
        ...
        pygame.draw.rect(surface,"#012169",r); pygame.draw.line(surface,"white",r.topleft,r.bottomright,2); pygame.draw.line(surface,"white",r.topright,r.bottomleft,2); pygame.draw.aacircle(surface,"#E4002B",(r.right-r.w//5,r.centery),max(2,r.h//7))
    elif country=="West Indies":
        pygame.draw.rect(surface,"#7B0041",r); pygame.draw.aacircle(surface,"#FFD100",r.center,r.h//4); pygame.draw.line(surface,"#007A3D",(r.centerx,r.centery-r.h//4),(r.centerx,r.bottom-2),2)
    else:
