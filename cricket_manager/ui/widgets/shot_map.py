...
class ShotMap:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        pygame.draw.circle(canvas, "#f0f6fc", centre, radius, 4)
        pygame.draw.rect(canvas, "#cbb98b", (centre[0] - 12, centre[1] - 38, 24, 76), border_radius=4)
        pygame.draw.line(canvas, "#f0f6fc", (centre[0] - 18, centre[1] - 22),
        ...
        if self.show_field:
            ...
            for label, (nx, ny) in positions.items():
                ...
                pygame.draw.circle(canvas, "#58a6ff", point, 8)
                pygame.draw.circle(canvas, "#dbeafe", point, 8, 2)
                tag = tiny.render(label, True, "#f0f6fc")
