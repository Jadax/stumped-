...
TEAM_DEFINITIONS = [
    # Division 1 — County Championship style (18 teams)
    ...
    ("Hampshire", 1, "English"),
    ("Somerset", 1, "English"),
    ("Warwickshire", 1, "English"),
    ("Nottinghamshire", 1, "English"),
    ("Derbyshire", 1, "English"),
    ("Durham", 1, "English"),
    ("Northamptonshire", 1, "English"),
    ("Gloucestershire", 1, "English"),
    ("Leicestershire", 1, "English"),
    ("Sussex", 1, "English"),
    ("Worcestershire", 1, "English"),
    ("Middlesex", 1, "English"),
    ("Glamorgan", 1, "English"),
    # Division 2 — Sheffield Shield style (18 teams)
    ("New South Wales", 2, "Australian"),
    ("Victoria", 2, "Australian"),
    ("Queensland", 2, "Australian"),
    ("South Australia", 2, "Australian"),
    ("Western Australia", 2, "Australian"),
    ("Tasmania", 2, "Australian"),
    ("Mumbai", 2, "Indian"),
    ("Delhi", 2, "Indian"),
    ("Karnataka", 2, "Indian"),
    ("Tamil Nadu", 2, "Indian"),
    ...
    ("Saurashtra", 2, "Indian"),
    ("Vidarbha", 2, "Indian"),
    # Division 3 — Ranji Trophy style (21 teams)
    ("Maharashtra", 3, "Indian"),
    ("Bengal", 3, "Indian"),
    ("Uttar Pradesh", 3, "Indian"),
    ("Madhya Pradesh", 3, "Indian"),
    ("Andhra", 3, "Indian"),
    ("Jharkhand", 3, "Indian"),
    ("Chhattisgarh", 3, "Indian"),
    ("Jammu & Kashmir", 3, "Indian"),
    ("Haryana", 3, "Indian"),
    ("Himachal Pradesh", 3, "Indian"),
    ("Kerala", 3, "Indian"),
    ("Goa", 3, "Indian"),
    ("Assam", 3, "Indian"),
    ("Tripura", 3, "Indian"),
    ("Services", 3, "Indian"),
    ("Railways", 3, "Indian"),
    ("Chhattisgarh Kings", 3, "Indian"),
    ("Rajasthan Bulls", 3, "Indian"),
    ("Chennai Falcons", 3, "Indian"),
    ("Kolkata Lions", 3, "Indian"),
    ("Mumbai Hawks", 3, "Indian"),
    # Division 4 — Big Bash/PSL style (20 teams)
    ...
    ("Lahore Qalandars", 4, "Pakistani"),
    ("Karachi Kings", 4, "Pakistani"),
    ...
    # Division 5 — IPL/CPL style (23 teams)
